...
<!-- The styles -->
<link id="bs-css" href="${req.contextPath}/charisma/css/bootstrap-cerulean.min.css"
      rel="stylesheet">

<link href="${req.contextPath}/charisma/css/charisma-app.css" rel="stylesheet">
<link href='${req.contextPath}/charisma/bower_components/fullcalendar/dist/fullcalendar.css'
      rel='stylesheet'>
<link href='${req.contextPath}/charisma/bower_components/fullcalendar/dist/fullcalendar.print.css'
      rel='stylesheet' media='print'>
<link href='${req.contextPath}/charisma/bower_components/chosen/chosen.min.css' rel='stylesheet'>
<link href='${req.contextPath}/charisma/bower_components/colorbox/example3/colorbox.css'
      rel='stylesheet'>
<link href='${req.contextPath}/charisma/bower_components/responsive-tables/responsive-tables.css'
      rel='stylesheet'>
<link
    href='${req.contextPath}/charisma/bower_components/bootstrap-tour/build/css/bootstrap-tour.min.css'
    rel='stylesheet'>
...
<script
    src="${req.contextPath}/charisma/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
...
<script
    src='${req.contextPath}/charisma/bower_components/fullcalendar/dist/fullcalendar.min.js'></script>
<!-- data table plugin -->
...
<script
    src="${req.contextPath}/charisma/bower_components/responsive-tables/responsive-tables.js"></script>
<!-- tour plugin -->
<script
    src="${req.contextPath}/charisma/bower_components/bootstrap-tour/build/js/bootstrap-tour.min.js"></script>
<!-- star rating plugin -->
